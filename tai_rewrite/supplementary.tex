...
The completed prompt-form diagnostic compared direct negation, generic concept prompts, enumeration-then-complement, and negative exemplars. Enumeration-then-complement was the only form that consistently produced a non-trivial structural signal.
\begin{table}[h]
\centering
